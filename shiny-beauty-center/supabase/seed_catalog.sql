...
values
  ('u0000001-0000-0000-0000-000000000001', 'layla@shiny.sa',    'authenticated', now(), now(),
   '{"full_name":"Layla Al-Rashidi"}'),
  ('u0000001-0000-0000-0000-000000000002', 'hessa@shiny.sa',    'authenticated', now(), now(),
   '{"full_name":"Hessa Al-Otaibi"}'),
  ('u0000001-0000-0000-0000-000000000003', 'noura@shiny.sa',    'authenticated', now(), now(),
...
values
  ('u0000001-0000-0000-0000-000000000001', 'Layla Al-Rashidi', '+966501110001', 'ar', true),
  ('u0000001-0000-0000-0000-000000000002', 'Hessa Al-Otaibi',  '+966501110002', 'ar', true),
  ('u0000001-0000-0000-0000-000000000003', 'Noura Al-Harbi',   '+966501110003', 'ar', true)
on conflict (id) do update set
...
do $$
declare
  sp1 uuid := 'p0000001-0000-0000-0000-000000000001';  -- Layla
  sp2 uuid := 'p0000001-0000-0000-0000-000000000002';  -- Hessa
  sp3 uuid := 'p0000001-0000-0000-0000-000000000003';  -- Noura
  d smallint;
begin
  ...
  insert into public.staff_availability (staff_id, day_of_week, start_time, end_time, is_available)
  values
    (sp1, 5, '10:00', '10:00', false),
    (sp2, 5, '10:00', '10:00', false),
    (sp3, 5, '10:00', '10:00', false)
  on conflict (staff_id, day_of_week) do update set
    is_available = false;
...
values
  ...
  ('cl000001-0000-0000-0000-000000000004',
...
values
  ('cl000001-0000-0000-0000-000000000001', 22,  'Completed appointment', 'appointment'),
  ('cl000001-0000-0000-0000-000000000001', 30,  'Completed appointment', 'appointment'),
  ('cl000001-0000-0000-0000-000000000002', 22,  'Completed appointment', 'appointment'),
  ('cl000001-0000-0000-0000-000000000003', 30,  'Completed appointment', 'appointment');
